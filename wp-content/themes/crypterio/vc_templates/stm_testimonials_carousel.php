	...
	<div class="<?php echo esc_attr( $css_class ); ?>" id="<?php echo esc_attr( $id ); ?>">
		<?php while( $testimonials->have_posts() ): $testimonials->the_post(); ?>
			...
			<?php if( $style == 'style_1' ) : ?>
				<?php if($crypterio_config['layout'] == 'layout_14' and !$disable_carousel): ?>
					<div class="testimonial">
						...
						<div class="image">
							<?php if ( $link['url'] ): ?>
								<a href="<?php echo esc_url( $link['url'] ); ?>"><?php echo crypterio_sanitize_text_field($author_photo['thumbnail']); ?></a>
							<?php else: ?>
								<?php echo crypterio_sanitize_text_field($author_photo['thumbnail']); ?>
							<?php endif; ?>
						</div>
						<div class="info">
							<?php
					...
					<div class="testimonial">
						...
						<div class="info">
							...
							<?php
								...
								$company = get_post_meta( get_the_ID(), 'testimonial_company', true );
							?>
							<?php if( $crypterio_config['layout'] == 'layout_8' || $crypterio_config['layout'] == 'layout_10' ) : ?>
								<?php
									$author_info = array();
			...
			<?php elseif( $style == 'style_2' ) : ?>
				...
				<div class="item">
					...
					<div class="testimonial-info clearfix">
						<div class="testimonial-image"><?php the_post_thumbnail( 'crypterio-image-50x50-croped' ); ?></div>
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				...
				<?php
					$opt = 'arrows: false,';
					 if( !$disable_carousel_arrows ) {
					    $opt = 'arrows: true,';
					    $opt .= 'prevArrow:"<div class=\"slick_prev\"><i class=\"fas fa-chevron-left\"></i></div>",';
					    $opt .= 'nextArrow: "<div class=\"slick_next\"><i class=\"fas fa-chevron-right\"></i></div>",';
					 }
				?>
				...
				<?php echo esc_attr( $id ) ?>.slick({
					...
					dots: false,
					infinite: true,
					<?php echo crypterio_sanitize_text_field($opt); ?>
					autoplaySpeed: 5000,
