        ...
        <?php if( $download_link ){ ?>
            <div class="stm-register-form">
                <form method="post">
                    ...
                    <input class="user_validated_field" type="email" name="stm_user_mail" placeholder="<?php esc_html_e('Enter your Email', 'crypterio') ?>"/>

                    <button type="submit" class="vc_general vc_btn3 vc_btn3-size-lg vc_btn3-shape-round vc_btn3-style-flat vc_btn3-color-theme_style_3 vc_btn3-icon-right" /><?php esc_html_e('Download now', 'crypterio'); ?> <i style="font-size:12px;" class="vc_btn3-icon stm-stm14_right_arrow"></i></button>
