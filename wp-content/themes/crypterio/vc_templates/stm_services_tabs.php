		...
		<div class="services_categories">
			<ul class="clearfix">
				<?php foreach ( $categories as $category ) { ?>
					<li>
						<a href="#service-tab-<?php echo esc_attr( $category->slug ); ?>" class="no_scroll"><?php echo esc_html( $category->name ); ?></a>
					</li>
				<?php } ?>
			</ul>
		</div>
					...
					<?php while ( $posts->have_posts() ) { $posts->the_post(); ?>
						...
						<div class="service_tab_item">
							...
							<div class="service_header">
								...
								<div class="service_cost heading_font"><?php echo esc_html( get_post_meta( get_the_ID(), 'service_cost', true ) ); ?></div>
							</div>
