...
<div class="event_lesson_tabs">
    <a href="#<?php echo esc_html($id); ?>" >
        <?php echo crypterio_sanitize_text_field($stm_event_lesson_title); ?>
                        ...
                        <div class="event_lesson_info_content">
                            ...
                            <?php foreach ($stm_event_speakers as $stm_event_speaker) : ?>
                                <li>
                                    ...
                                    ?>
                                    <div class="event_speaker_thumbnail"><?php echo crypterio_sanitize_text_field($post_thumbnail); ?></div>
