...
<div class="mini-cart">
    <div class="mini-cart__products">
        ...
        if (sizeof(WC()->cart->get_cart()) > 0) :
            ...
            <?php endforeach; ?>
        <?php else : ?>
            <div class="mini-cart__empty"><?php esc_html_e('No products in the cart.', 'crypterio'); ?></div>
        <?php endif; ?>
    </div>
    <?php if (sizeof(WC()->cart->get_cart()) > 0) : ?>
        <div class="mini-cart__price-total"><?php esc_html_e('Subtotal', 'crypterio'); ?>
            : <?php echo WC()->cart->get_cart_subtotal(); ?></div>
        <div class="mini-cart__actions">
            <a href="<?php echo wc_get_checkout_url(); ?>"
               class=" btn btn_primary btn_solid"><?php esc_html_e('Checkout', 'crypterio'); ?></a>
            <a href="<?php echo wc_get_cart_url(); ?>"
               class="mini-cart__action-link"><?php esc_html_e('View cart', 'crypterio'); ?></a>
        </div>
    <?php endif; ?>
</div>