	...
	function crypterio_config() {
		...
		switch ( $config['layout'] ) {
			...
			case 'counselor':
				...
				$config['fonts']           = array(
					'maven_pro' => 'Maven Pro:300,400,500,600,700',
					'catamaran' => 'Catamaran:300,400,500,600,700',
				);
				$config['base_color']      = '#171717';
				$config['secondary_color'] = '#2d99fe';
				$config['third_color']     = '#fcd90b';
			...
			case 'ico_isometric':
				...
				$config['fonts'] = array(
					'open_sans' => 'Open Sans:300,400,500,600,700',
					'poppins'   => 'Poppins:300,400,500,600,700',
				);

				$config['base_color']      = '#00aaff';
				$config['secondary_color'] = '#40f599';
				$config['third_color']     = '#26211d';
			...
			case 'nft':
				...
				$config['secondary_font_family']  = '"Michroma"';
				$config['secondary_font_classes'] = 'h1, .h1,
					h2, .h2,
					h3, .h3,
					h4, .h4,
				...
				$config['base_color']      = '#111111';
				$config['secondary_color'] = '#d3ff5c';
				$config['third_color']     = '#222222';
