...
if ( ! class_exists( 'Envato_Market_Admin' ) && class_exists( 'Envato_Market' ) ) :
	...
	class Envato_Market_Admin {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'crypterio' ), '1.0.0' );
		}
		...
		public function maybe_delete_transients() {
			if ( isset( $_POST[ envato_market()->get_option_name() ] ) ) {
				...
				if ( isset( $_POST['_wpnonce'] ) && ! wp_verify_nonce( $_POST['_wpnonce'], envato_market()->get_slug() . '-options' ) ) {
		 			wp_die( esc_html__( 'You do not have sufficient permissions to delete transients.', 'crypterio' ) );
				}
		...
		public function admin_enqueue_script() {
			...
			$exports = array(
				...
				'i18n' => array(
					'save' => esc_html__( 'Save', 'crypterio' ),
					'remove' => esc_html__( 'Remove', 'crypterio' ),
					'cancel' => esc_html__( 'Cancel', 'crypterio' ),
					'error' => esc_html__( 'An unknown error occurred. Try again.', 'crypterio' ),
				),
			);
		...
		public function render_templates() {
			...
			<script type="text/html" id="tmpl-envato-market-auth-check-button">
				<a href="<?php echo esc_url( add_query_arg( array( 'authorization' => 'check' ), envato_market()->get_page_url() ) ); ?>" class="button button-secondary auth-check-button" style="margin:0 5px"><?php esc_html_e( 'Test API Connection', 'crypterio' ); ?></a>
			</script>

			<script type="text/html" id="tmpl-envato-market-item">
				<li data-id="{{ data.id }}">
					<span class="item-name"><?php esc_html_e( 'ID', 'crypterio' ); ?>: {{ data.id }} - {{ data.name }}</span>
					<button class="item-delete dashicons dashicons-dismiss">
						<span class="screen-reader-text"><?php esc_html_e( 'Delete', 'crypterio' ) ?></span>
					</button>
			...
			<script type="text/html" id="tmpl-envato-market-dialog-remove">
				<div id="envato-market-dialog-remove" title="<?php esc_html_e( 'Remove Item', 'crypterio' ) ?>">
					<p><?php esc_html_e( 'You are about to remove the connection between the Envato Market API and this item. You cannot undo this action.', 'crypterio' ) ?></p>
				</div>
			</script>

			<script type="text/html" id="tmpl-envato-market-dialog-form">
				<div id="envato-market-dialog-form" title="<?php esc_html_e( 'Add Item', 'crypterio' ) ?>">
					<form>
						<fieldset>
							<label for="token"><?php esc_html_e( 'Token', 'crypterio' ) ?></label>
							<input type="text" name="token" class="widefat" value="" />
							<p class="description"><?php esc_html_e( 'Enter the Envato API Personal Token.', 'crypterio' ); ?></p>
							<label for="id"><?php esc_html_e( 'Item ID', 'crypterio' ) ?></label>
							<input type="text" name="id" class="widefat" value="" />
							<p class="description"><?php esc_html_e( 'Enter the Envato Item ID.', 'crypterio' ); ?></p>
						...
						<div class="envato-card-top">
							...
							<div class="column-name">
								<h4>
									...
									<span class="version" aria-label="<?php esc_attr_e( 'Version %s', 'crypterio' ); ?>"><?php esc_html_e( 'Version', 'crypterio' ); ?> {{ data.version }}</span>
								</h4>
							</div>
							<div class="column-description">
								...
								<p class="author">
									<cite><?php esc_html_e( 'By', 'crypterio' ); ?> {{ data.author }}</cite>
								</p>
							</div>
						</div>
						<div class="envato-card-bottom">
							<div class="column-actions">
								<a href="{{{ data.install }}}" class="button button-primary">
									<span aria-hidden="true"><?php esc_html_e( 'Install', 'crypterio' ); ?></span>
									<span class="screen-reader-text"><?php esc_html_e( 'Install', 'crypterio' ); ?> {{ data.name }}</span>
								</a>
							</div>
						</div>
					</div>
		...
		public function register_settings() {
			...
			add_settings_section(
			 ...
			 esc_html__( 'Global OAuth Personal Token', 'crypterio' ),
			...
			add_settings_section(
			 ...
			 esc_html__( 'Single Use OAuth Personal Tokens', 'crypterio' ),
			...
			add_settings_field(
				'items',
			 esc_html__( 'Envato Market Items', 'crypterio' ),
		...
		public function install_plugin( $plugin ) {
			if ( ! current_user_can( 'install_plugins' ) ) {
				$msg = '
				<div class="wrap">
					<h1>' . esc_html__( 'Installing Plugin...', 'crypterio' ) . '</h1>
					<p>' . esc_html__( 'You do not have sufficient permissions to install plugins on this site.', 'crypterio' ) . '</p>
					<a href="' . esc_url( 'admin.php?page=' . envato_market()->get_slug() . '&tab=plugins' ) . '">' . esc_html__( 'Return to Plugin Installer', 'crypterio' ) . '</a>
				</div>';
				wp_die( $msg );
			}
			...
			if ( empty( $array_api ) ) {
				...
				<div class="wrap">
					<h1>' . esc_html__( 'Installing Plugin...', 'crypterio' ) . '</h1>
					<p>' . esc_html__( 'An error occurred, please check that the item ID is correct.', 'crypterio' ) . '</p>
					<a href="' . esc_url( 'admin.php?page=' . envato_market()->get_slug() . '&tab=plugins' ) . '">' . esc_html__( 'Return to Plugin Installer', 'crypterio' ) . '</a>
				</div>';
				wp_die( $msg );
			}

			$title = sprintf( esc_html__( 'Installing Plugin: %s', 'crypterio' ), $api->name . ' ' . $api->version );
		...
		public function install_theme( $theme ) {
			if ( ! current_user_can( 'install_themes' ) ) {
				$msg = '
				<div class="wrap">
					<h1>' . esc_html__( 'Installing Theme...', 'crypterio' ) . '</h1>
					<p>' . esc_html__( 'You do not have sufficient permissions to install themes on this site.', 'crypterio' ) . '</p>
					<a href="' . esc_url( 'admin.php?page=' . envato_market()->get_slug() . '&tab=themes' ) . '">' . esc_html__( 'Return to Theme Installer', 'crypterio' ) . '</a>
				</div>';
				wp_die( $msg );
			}
			...
			if ( empty( $array_api ) ) {
				...
				<div class="wrap">
					<h1>' . esc_html__( 'Installing Theme...', 'crypterio' ) . '</h1>
					<p>' . esc_html__( 'An error occurred, please check that the item ID is correct.', 'crypterio' ) . '</p>
					<a href="' . esc_url( 'admin.php?page=' . envato_market()->get_slug() . '&tab=themes' ) . '">' . esc_html__( 'Return to Plugin Installer', 'crypterio' ) . '</a>
				</div>';
				wp_die( $msg );
			}
			...
			$title = sprintf( esc_html__( 'Installing Theme: %s', 'crypterio' ), $api->name . ' ' . $api->version );
		...
		public function ajax_upgrade_theme() {
			...
			if ( $theme_data->exists() && $theme_data->get( 'Version' ) ) {
				$status['oldVersion'] = sprintf( esc_html__( 'Version %s', 'crypterio' ), $theme_data->get( 'Version' ) );
			}

			if ( ! current_user_can( 'update_themes' ) ) {
				$status['error'] = esc_html__( 'You do not have sufficient permissions to update themes for this site.', 'crypterio' );
			...
			if ( is_array( $result ) && ! empty( $result[ $theme ] ) ) {
				...
				if ( $theme_data->exists() && $theme_data->get( 'Version' ) ) {
					$status['newVersion'] = sprintf( esc_html__( 'Version %s', 'crypterio' ), $theme_data->get( 'Version' ) );
				}
				...
				$status['error'] = esc_html__( 'Unable to connect to the filesystem. Please confirm your credentials.', 'crypterio' );
		...
		public function ajax_add_item() {
			if ( ! check_ajax_referer( self::AJAX_ACTION, 'nonce', false ) ) {
				...
				wp_send_json_error( array( 'message' => esc_html__( 'The Token is missing.', 'crypterio' ) ) );
			} elseif ( empty( $_POST['id'] ) ) {
				wp_send_json_error( array( 'message' => esc_html__( 'The Item ID is missing.', 'crypterio' ) ) );
			}
			...
			if ( false === $request ) {
				wp_send_json_error( array( 'message' => esc_html__( 'The Token or Item ID is incorrect.', 'crypterio' ) ) );
			}

			if ( false === envato_market()->api()->download( $_POST['id'], $args ) ) {
				wp_send_json_error( array( 'message' => esc_html__( 'The item cannot be downloaded.', 'crypterio' ) ) );
			}
			...
			wp_send_json_error( array( 'message' => esc_html__( 'An unknown error occurred.', 'crypterio' ) ) );
		}
		...
		public function blockchain_require_file($path) {
		...
		public function render_admin_callback() {
			$this->blockchain_require_file( 'inc/admin/view/callback/admin.php' );
		}
		...
		public function render_oauth_section_callback() {
			$this->blockchain_require_file( 'inc/admin/view/callback/section/oauth.php' );
		}
		...
		public function render_items_section_callback() {
			$this->blockchain_require_file( 'inc/admin/view/callback/section/items.php' );
		}
		...
		public function render_token_setting_callback() {
			$this->blockchain_require_file( 'inc/admin/view/callback/setting/token.php' );
		}
		...
		public function render_items_setting_callback() {
			$this->blockchain_require_file( 'inc/admin/view/callback/setting/items.php' );
		}
		...
		public function render_intro_partial() {
			$this->blockchain_require_file( 'inc/admin/view/partials/intro.php' );
		}
		...
		public function render_tabs_partial() {
			$this->blockchain_require_file( 'inc/admin/view/partials/tabs.php' );
		}
		...
		public function render_settings_panel_partial() {
			$this->blockchain_require_file( 'inc/admin/view/partials/settings.php' );
		}
		...
		public function render_themes_panel_partial() {
			$this->blockchain_require_file( 'inc/admin/view/partials/themes.php' );
		}
		...
		public function render_plugins_panel_partial() {
			$this->blockchain_require_file( 'inc/admin/view/partials/plugins.php' );
		}
		...
		public function render_success_notice() {
			$this->blockchain_require_file( 'inc/admin/view/notice/success.php' );
		}
		...
		public function render_success_no_items_notice() {
			$this->blockchain_require_file( 'inc/admin/view/notice/success-no-items.php' );
		}
		...
		public function render_success_single_use_notice() {
			$this->blockchain_require_file( 'inc/admin/view/notice/success-single-use.php' );
		}
		...
		public function render_error_notice() {
			$this->blockchain_require_file( 'inc/admin/view/notice/error.php' );
		}
		...
		public function render_error_single_use_notice() {
			$this->blockchain_require_file( 'inc/admin/view/notice/error-single-use.php' );
		}
	}
