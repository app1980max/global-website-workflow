            ...
            <div class="stm_ico_countdown__links">
                <div class="stm_countdown_top_part">
                    ...
                    if( class_exists( 'VCW_Data' ) && method_exists('VCW_Data', 'coin')) {
                        ...
                        $eth_sum = $price_num / $eth[ 'price' ][ 'usd' ];
                        $currencie_1_sum = $price_num / $currencie_1[ 'price' ][ 'usd' ];
                        $currencie_2_sum = $price_num / $currencie_2[ 'price' ][ 'usd' ];
                        ?>
                        <div class="stm_raised_currencies">
                            <img src="<?php echo esc_url( $eth[ 'image_small' ] ); ?>" width="32px"
                                 alt="<?php echo esc_attr__( 'Ethereum', 'crypterio' ); ?>"/>
                        ...
                        <div class="stm_raised_currencies">
                            <img src="<?php echo esc_url( $currencie_1[ 'image_small' ] ); ?>" width="32px"
                                 alt="<?php echo esc_attr( $cur_name ); ?>"/>
                        ...
                        <div class="stm_raised_currencies">
                            <img src="<?php echo esc_url( $currencie_2[ 'image_small' ] ); ?>" width="32px"
                                 alt="<?php echo esc_attr( $cur_name_2 ); ?>"/>
