(function ($) {
    ...
    $(document).ready(function(){
        $('.stm_layout_font_enabler').on('click', function(){
            $('.stm_layout_font_enabler').attr('disabled', 'disabled');
            if(!$(this).hasClass('loading')) {
                ...
                $.ajax({
                    ...
                    data: {
                        'font': font,
                        'action': 'stm_icons_load',
                        'security': window.wp_data.stm_icons_load,
                    },
                    beforeSend: function () {
                    ...
                    complete: function (data) {
                        ...
                        $('.stm_layout_font_enabler').removeAttr('disabled', 'disabled');
                        var dt = data.responseJSON;
                        $(this).text(dt.text);
                        $(this).removeClass(dt.r_class);
                        $(this).addClass(dt.class);
                    }
                });
            }
        })
