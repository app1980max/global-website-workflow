...
function mytheme_menu_item_additional_fields($fields)
{
    $fields['stm_mega'] = array(
        'name' => 'stm_mega',
        'label' => __('Megamenu type', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_0',
        'container_class' => 'stm_mega stm_megamenu_select',
        'input_type' => 'select',
        'options' => array(
            'disabled' => __('Disabled', 'stm-configurations'),
            'boxed' => __('Boxed', 'stm-configurations'),
            'wide' => __('Wide', 'stm-configurations'),
        )
    );

    $fields['stm_mega_cols'] = array(
        'name' => 'stm_mega_cols',
        'label' => __('Megamenu columns width', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_0',
        'container_class' => 'stm_mega_cols stm_megamenu_select',
        'input_type' => 'select',
        'options' => array(
            'default' => __('Default', 'stm-configurations'),
            '1' => '1 column - 1/12',
            '2' => '2 columns - 1/6',
            '3' => '3 columns - 1/4',
            '4' => '4 columns - 1/3',
    ...
    $fields['stm_mega_col_width'] = array(
        ...
        'label' => __('Megamenu column width', 'stm-configurations'),
    ...
    $fields['stm_mega_cols_inside'] = array(
        ...
        'label' => __('Megamenu child columns width', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_1',
    ...
    $fields['stm_menu_icon'] = array(
        'name' => 'stm_menu_icon',
        'label' => __('Megamenu icon', 'stm-configurations'),
    ...
    $fields['stm_menu_image'] = array(
        'name' => 'stm_menu_image',
        'label' => __('Megamenu image', 'stm-configurations'),
        'new' => __('Add image', 'stm-configurations'),
        'delete' => __('Remove image', 'stm-configurations'),
        'replace' => __('Replace image', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_1 stm_visible_lvl_2',
    ...
    $fields['stm_mega_textarea'] = array(
        ...
        'label' => __('Megamenu textarea', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_2',
    ...
    $fields['stm_menu_bg'] = array(
        'name' => 'stm_menu_bg',
        'label' => __('Megamenu background', 'stm-configurations'),
        'new' => __('Add image', 'stm-configurations'),
        'delete' => __('Remove image', 'stm-configurations'),
        'replace' => __('Replace image', 'stm-configurations'),
        'wrap' => 'stm_visible_lvl_0',
