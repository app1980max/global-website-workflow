...
/* -------------------- Fonts -------------------- */
$wpstr_fonts = wpstr_css_fonts();

$wpstrstr = " h1,h2,h3,h4,h5,h6,.wrap h2, .wrap h1, "
...
_e($wpstrstr."{".$wpstr_fonts['head_font_css']."}");
...
echo $wpstrstr."{".$wpstr_fonts['body_font_css']."}";

$wpstrstr = " #adminmenu .wp-submenu-head, #adminmenu a.menu-top, "
			...
			."#collapse-menu";
echo $wpstrstr."{".$wpstr_fonts['menu_font_css']."}";


$wpstrstr = " .wp-core-ui .button, .wp-core-ui .button-secondary,"
			.".wp-core-ui .button-primary, i.wpstrwaves-effect input, "
			.".upload-plugin .install-help, .upload-theme .install-help,"
			.".wordfenceWrap input[type='button'], .wordfenceWrap input[type='submit']";
echo $wpstrstr."{".$wpstr_fonts['button_font_css']."}";
...
if($wpstradmin["topbar-menu-bg"]['background-color'] == "transparent"){
	echo " #screen-meta-links .show-settings, #screen-meta-links .show-settings:active, #screen-meta-links .show-settings:focus, #screen-meta-links .show-settings:hover, #screen-meta-links .show-settings:after{color: ".$wpstradmin['topbar-menu-color']."; background: transparent;} #screen-meta-links .screen-meta-toggle{background:transparent;}";
} else {
	$wpstrstr = "#screen-meta-links .show-settings,#screen-meta-links .show-settings:after";
	echo wpstr_css_color($wpstrstr, "body-text-color", "1.0") . "\n";
}

echo " \n/* -- Page BG -- */\n";
echo wpstr_css_background("html, body, #wp-content-editor-tools, #ws_menu_editor .ws_editbox", "page-bg", "1.0") . "\n";
echo wpstr_css_background("#wpcontent:before", "page-heading-bg", "1.0") . "\n";


echo " \n/* -- Heading -- */\n";
$wpstrstr = " h1,h2,h3,h4,h5,h6, .wrap h2, .wrap h1 , .welcome-panel .about-description, .theme-browser .theme.active .theme-name, #dashboard-widgets h3, #dashboard-widgets h4, #dashboard_quick_press .drafts h2";
echo wpstr_css_color($wpstrstr, "heading-color", "1.0") . "\n";




echo " \n/* -- body text -- */\n";
$wpstrstr = " body, p, #screen-meta-links.opened .screen-meta-toggle .show-settings,#screen-meta-links.opened .show-settings:after, .widefat p, #submitted-on, .submitted-on,.widefat td, .widefat th,.tablenav .tablenav-pages, .form-table th, .form-wrap label, "
...
echo " \n/* -- link color -- */\n";
echo wpstr_link_color("a, .no-plugin-results a", "link-color") . "\n";
...
echo " \n/* -- Form element -- */\n";
$wpstrstr = " #adduser .form-table input, #createuser .form-table input, .form-table input[type=text], .form-table input[type=password], .form-table input[type=email], .form-table input[type=number], .form-table input[type=search], .form-table input[type=tel], .form-table input[type=url], .form-table textarea, .form-table select, input[type=checkbox], input[type=color], input[type=date], input[type=datetime-local], input[type=datetime], input[type=email], input[type=month], input[type=number], input[type=password], input[type=radio], input[type=search], input[type=tel], input[type=text], input[type=time], input[type=url], input[type=week], select, textarea, #createuser .form-table input[type='checkbox'],".
...
echo wpstr_css_bgcolor($wpstrstr, "form-bg", "1.0") . "\n";
echo wpstr_css_border_color($wpstrstr, "form-border-color", "", "all") . "\n";
echo wpstr_css_color($wpstrstr, "form-text-color", "1.0") . "\n";

echo " \n/* -- Post Title -- */\n";
$wpstrstr = " #titlediv #title";
echo wpstr_css_border_color($wpstrstr, "form-border-color", "", "all") . "\n";
...
echo wpstr_css_color($primary_color_str, "primary-color", "1.0") . "\n";
...
echo wpstr_css_bgcolor($primary_bgcolor_str, "primary-color", "1.0") . "\n";

$pace_bgcolor_str = ".pace .pace-progress";
echo wpstr_css_bgcolor($pace_bgcolor_str, "pace-color", "1.0") . "\n";
...
echo wpstr_css_border_color($primary_border_str, "primary-color", "1.0","all") . "\n";
echo ".has-dfw .quicktags-toolbar{border-color:".$wpstradmin['primary-color']." !important;}";
...
echo wpstr_css_border_color($primary_border_bottom, "primary-color", "1.0","bottom") . "\n";

$primary_border_top = ".post-com-count:hover:after, .media-frame.mode-grid .attachments-browser .attachments";
echo wpstr_css_border_color($primary_border_top, "primary-color", "1.0","top") . "\n";

$primary_border_left = ".plugins .active th.check-column";
echo wpstr_css_border_color($primary_border_left, "primary-color", "1.0","left") . "\n";
...
echo "#wp-fullscreen-buttons .mce-btn:focus, #wp-fullscreen-buttons .mce-btn:hover, .mce-toolbar .mce-btn-group .mce-btn:focus, .mce-toolbar .mce-btn-group .mce-btn:hover, .qt-fullscreen:focus, .qt-fullscreen:hover,"
	...
	."background: ".$wpstradmin['primary-color']." !important;"
	."border-color: ".$wpstradmin['primary-color']." !important;"
	."color: ".$wpstradmin['button-text-color']." !important;"
	."}";

echo ".wrap .add-new-h2, .wrap .page-title-action{"
	."background: ".$wpstradmin['button-secondary-bg']." !important;"
	."color: ".$wpstradmin['button-text-color']." !important;"
	."}";


echo ".toplevel_page__wpstroptions #reduk-header{border-color:".$wpstradmin['primary-color']." !important;background-color:".$wpstradmin['primary-color']." !important;}";
...
.media-progress-bar div{
	background-color: ".$wpstradmin['primary-color'].";
}

.media-modal-content .attachment.details {
	-webkit-box-shadow: inset 0 0 0 3px #fff,inset 0 0 0 7px ".$wpstradmin['primary-color'].";
	box-shadow: inset 0 0 0 3px #fff,inset 0 0 0 7px ".$wpstradmin['primary-color'].";
	-moz-box-shadow: inset 0 0 0 3px #fff,inset 0 0 0 7px ".$wpstradmin['primary-color'].";
	-ms-box-shadow: inset 0 0 0 3px #fff,inset 0 0 0 7px ".$wpstradmin['primary-color'].";
	-o-box-shadow: inset 0 0 0 3px #fff,inset 0 0 0 7px ".$wpstradmin['primary-color'].";
}
/*
...
.attachment.details .check, .attachment.selected .check:focus, .media-frame.mode-grid .attachment.selected .check {
	background-color: ".$wpstradmin['primary-color'].";
	-webkit-box-shadow: 0 0 0 1px #fff,0 0 0 2px ".$wpstradmin['primary-color'].";
	box-shadow: 0 0 0 1px #fff,0 0 0 2px ".$wpstradmin['primary-color'].";
	-moz-box-shadow: 0 0 0 1px #fff,0 0 0 2px ".$wpstradmin['primary-color'].";
	-ms-box-shadow: 0 0 0 1px #fff,0 0 0 2px ".$wpstradmin['primary-color'].";
	-o-box-shadow: 0 0 0 1px #fff,0 0 0 2px ".$wpstradmin['primary-color'].";
}";
...
{
	border-right-color: ".$wpstradmin['primary-color'].";
}

";


echo " #ws_menu_editor.ws_is_actor_view .ws_is_hidden_for_actor{background-color: ".$wpstradmin['primary-color']." !important;}";
echo " #ws_menu_editor.ws_is_actor_view .ws_is_hidden_for_actor.ws_active{background-color: ".$wpstradmin['box-head-bg']['background-color']." !important;}";
...
echo " \n/* -- Menu BG -- */\n";
$wpstrstr = " #adminmenu, #adminmenu .wp-submenu, #adminmenuback, #adminmenuwrap,"
		   ."#adminmenu .wp-has-current-submenu .wp-submenu, #adminmenu .wp-has-current-submenu .wp-submenu.sub-open, #adminmenu .wp-has-current-submenu.opensub .wp-submenu, #adminmenu a.wp-has-current-submenu:focus+.wp-submenu, .no-js li.wp-has-current-submenu:hover .wp-submenu,"
		   ."#adminmenu .wp-submenu, .folded #adminmenu .wp-has-current-submenu .wp-submenu";
echo wpstr_css_background($wpstrstr, "menu-bg", "1.0") . "\n";

echo " \n/* -- Menu Text color -- */\n";
$wpstrstr = " #adminmenu a, #adminmenu li.menu-top:hover, "
			."#adminmenu li.opensub>a.menu-top, #adminmenu li>a.menu-top:focus, "
			."#ws_menu_editor .ws_item_title, "
		."#adminmenuwrap .menu-userinfo .disproles, #adminmenuwrap .menu-userinfo .dispname a, #adminmenuwrap .wpstr-menu-profile-links:after,#collapse-button .collapse-button-icon:after,.collapse-button-label";

echo wpstr_css_color($wpstrstr, "menu-color", "1.0") . "\n";

$wpstrstr = "#adminmenu a:hover, #adminmenu li.menu-top>a:focus,  #adminmenu li.menu-top:hover, #adminmenu li.opensub>a.menu-top, #adminmenu li>a.menu-top:focus, "
			."#adminmenu .wp-has-current-submenu .wp-submenu .wp-submenu-head, #adminmenu .wp-menu-arrow, #adminmenu .wp-menu-arrow div, #adminmenu li.current a.menu-top, #adminmenu li.wp-has-current-submenu a.wp-has-current-submenu, .folded #adminmenu li.current.menu-top, .folded #adminmenu li.wp-has-current-submenu,"
			."#adminmenuwrap .wpstr-menu-profile-links .all-links li a,#collapse-menu:hover #collapse-button .collapse-button-icon:after,#collapse-button:hover .collapse-button-label";
echo wpstr_css_color($wpstrstr, "menu-hover-color", "1.0") . "\n";
...
echo wpstr_css_color($wpstrstr, "menu-icon-color", "1.0") . "\n";

$wpstrstr = " #adminmenu li:hover div.wp-menu-image:before, "
...
echo wpstr_css_color($wpstrstr, "menu-icon-hover-color", "1.0") . "\n";
...
echo " \n/* -- Menu primary bg -- */\n";
$wpstrstr = " #adminmenu li.menu-top:hover, #adminmenu li.opensub>a.menu-top, #adminmenu li>a.menu-top:focus, "
			."#adminmenu .wp-has-current-submenu .wp-submenu .wp-submenu-head, #adminmenu .wp-menu-arrow, #adminmenu .wp-menu-arrow div, #adminmenu li.current a.menu-top, #adminmenu li.wp-has-current-submenu a.wp-has-current-submenu, .folded #adminmenu li.current.menu-top, .folded #adminmenu li.wp-has-current-submenu, "
			."#adminmenuwrap .wpstr-menu-profile-links .all-links,#collapse-button:hover";
echo wpstr_css_bgcolor($wpstrstr, "menu-primary-bg", "1.0") . "\n";

echo " \n/* -- Menu primary border left -- */\n";

$wpstrstr = "#adminmenu li a.menu-top:hover, 
...
echo wpstr_css_border_color($wpstrstr, "primary-color", "1.0","left") . "\n";


echo " \n/* -- SubMenu -- */\n";
$wpstrstr = " .folded #adminmenu li.menu-top .wp-submenu>li>a:hover, #adminmenu .wp-submenu a:focus, #adminmenu .wp-submenu a:hover, #adminmenu .wp-submenu li.current a, #adminmenu .wp-submenu li.current a:hover";
echo wpstr_css_bgcolor($wpstrstr, "menu-secondary-bg", "1.0") . "\n";
echo wpstr_css_color($wpstrstr, "submenu-color", "1.0") . "\n";
echo wpstr_css_border_color($wpstrstr, "primary-color", "", "left") . "\n";

$wpstrstr = " #adminmenu .opensub .wp-submenu li.current a, #adminmenu .wp-submenu li.current, #adminmenu .wp-submenu li.current a, #adminmenu .wp-submenu li.current a:focus, #adminmenu .wp-submenu li.current a:hover, #adminmenu a.wp-has-current-submenu:focus+.wp-submenu li.current a,"
			."#adminmenu .wp-submenu a";
echo wpstr_css_color($wpstrstr, "submenu-color", "1.0") . "\n";


echo " \n/* -- Floating SubMenu -- */\n";
$wpstrstr = " #adminmenu .wp-not-current-submenu li>a:hover, .folded #adminmenu .wp-has-current-submenu li>a:hover";
echo wpstr_css_color($wpstrstr, "submenu-color", "1.0") . "\n";
echo wpstr_css_bgcolor($wpstrstr, "menu-secondary-bg", "1.0") . "\n";
echo wpstr_css_border_color($wpstrstr, "primary-color", "", "left") . "\n";
...
$wpstrstr = " #adminmenu li.wp-has-submenu.wp-not-current-submenu.opensub:hover:after";
echo wpstr_css_border_color($wpstrstr, $wpstradmin['menu-bg']['background-color'],"","right","string");


echo " \n/* -- Collapsed Submenu - Menu Text color -- */\n";
echo wpstr_css_color(".folded #adminmenu .wp-submenu .wp-submenu-head, .auto-fold #adminmenu .wp-submenu .wp-submenu-head", "menu-color", "1.0") . "\n";


echo " \n/* -- Collapsed Submenu - SubMenu Text color -- */\n";
$wpstrstr = " #collapse-menu, #collapse-menu:hover, #collapse-menu:hover #collapse-button div:after, #collapse-button div:after";
echo wpstr_css_color($wpstrstr, "submenu-color", "1.0") . "\n";


echo " \n/* -- Collapsed SubMenu -- */\n";
$wpstrstr = " .folded #adminmenu li.menu-top .wp-submenu>li>a.current";
echo wpstr_css_border_color($wpstrstr, "primary-color", "", "left") . "\n";



echo " \n/* -- Logo BG -- */\n";
$wpstrstr = " #adminmenuwrap:before, .folded #adminmenuwrap:before";
echo wpstr_css_bgcolor($wpstrstr, "logo-bg", "1.0") . "\n";
...
echo wpstr_css_background($wpstrstr, "box-bg", "1.0") . "\n";

$wpstrstr = " .welcome-panel";
// echo wpstr_css_background($wpstrstr, "box-bg", "1.0") . "\n";
echo wpstr_css_bgcolor($wpstrstr, "primary-color", "1.0") . "\n";



echo " \n/* -- Box Head -- */\n";
$wpstrstr = " .postbox .hndle, .stuffbox .hndle, 
...
echo wpstr_css_background($wpstrstr, "box-head-bg", "1.0") . "\n";
echo wpstr_css_color($wpstrstr, "box-head-color", "1.0") . "\n";

$wpstrstr = " .welcome-panel h2";
echo wpstr_css_color($wpstrstr, "#ffffff", "1.0","string") . "\n";



$wpstrstr = " #ws_menu_editor .ws_main_container .ws_container.ws_active";
echo wpstr_css_background($wpstrstr, "box-head-bg", "1.0") . "\n";
$wpstrstr = " #ws_menu_editor .ws_item_title";
echo wpstr_css_color($wpstrstr, "box-head-color", "1.0") . "\n";



echo " \n/* -- Data Tables Head -- */\n";
$wpstrstr = " table.widefat thead tr, table.widefat tfoot tr";
echo wpstr_css_background($wpstrstr, "box-head-bg", "1.0") . "\n";
...
$wpstrstr = " .js .control-section .accordion-section-title:focus, .js .control-section .accordion-section-title:hover, .js .control-section.open .accordion-section-title, .js .control-section:hover .accordion-section-title";
echo wpstr_css_background($wpstrstr, "box-head-bg", "1.0") . "\n";
echo wpstr_css_color($wpstrstr, "box-head-color", "1.0") . "\n";


echo " \n/* --Plugin Upload -- */\n";
$wpstrstr = " .upload-plugin .wp-upload-form, .upload-theme .wp-upload-form";
echo wpstr_css_background($wpstrstr, "box-head-bg", "1.0") . "\n";
echo wpstr_css_color($wpstrstr, "box-head-color", "1.0") . "\n";


echo " \n/* -- Box Head toggle arrow - Using opacity-- */\n";
$wpstrstr = " .js .meta-box-sortables .postbox .handlediv:before, .js .sidebar-name .sidebar-name-arrow:before, "
...
echo wpstr_css_color($wpstrstr, "box-head-color", "0.7") . "\n";
    
echo " \n/* -- Box Head toggle arrow - Using opacity-- !important */\n";
echo "#bulk-titles div a:before, #welcome-panel.welcome-panel .welcome-panel-close:before, .tagchecklist span a:before{color: ".wpstr_colorcode($wpstradmin['box-head-color'],"0.7","!important")."} ";
echo ".accordion-section-title:focus:after, .accordion-section-title:hover:after{border-color: ".wpstr_colorcode($wpstradmin['box-head-color'],"0.7"," transparent")."}";
...
echo wpstr_css_color($wpstrstr, "button-text-color", "1.0") . "\n";


echo " \n/* -- Button secondary bg color -- */\n";
$wpstrstr = " .wp-core-ui .button, .wp-core-ui .button-secondary, .wordfenceWrap input[type='button'], .wordfenceWrap input[type='submit'],i.button.wpstrwaves-effect";
echo wpstr_css_bgcolor($wpstrstr, "button-secondary-bg", "1.0") . "\n";


echo " \n/* -- Button secondary hover bg color -- */\n";
$wpstrstr = " .wp-core-ui .button-secondary:focus, .wp-core-ui .button-secondary:hover, .wp-core-ui .button.focus, .wp-core-ui .button.hover, .wp-core-ui .button:focus, .wp-core-ui .button:hover,"
		   ."#edit-slug-box .edit-slug.button:hover, #edit-slug-box #view-post-btn .button:hover";
echo wpstr_css_bgcolor($wpstrstr, "button-secondary-hover-bg", "1.0") . "\n";


echo " \n/* -- Button primary bg color -- */\n";
$wpstrstr = " .wp-core-ui .button-primary,"
		   .".row-actions span a:hover,.row-actions span button.button-link:hover,"
		   .".plugin-card .install-now.button, .plugin-card .button,"
		   .".wordfenceWrap input[type='button'], .wordfenceWrap input[type='submit'],i.button.wpstrwaves-effect.button-primary";
echo wpstr_css_bgcolor($wpstrstr, "button-primary-bg", "1.0") . "\n";


echo " \n/* -- Button primary hover bg color -- */\n";
$wpstrstr = " .wp-core-ui .button-primary.focus, .wp-core-ui .button-primary.hover, .wp-core-ui .button-primary:focus, .wp-core-ui .button-primary:hover,i.button.wpstrwaves-effect.button-primary:hover,i.button.wpstrwaves-effect.button-primary:focus,"
...
echo wpstr_css_bgcolor($wpstrstr, "button-primary-hover-bg", "1.0") . "\n";

echo " \n/* ---- disabled button - !important ----- */\n";
$wpstrstr = " .wp-core-ui .button-primary-disabled, .wp-core-ui .button-primary.disabled, .wp-core-ui .button-primary:disabled, .wp-core-ui .button-primary[disabled]";
echo $wpstrstr." {color: ".wpstr_colorcode($wpstradmin['button-text-color'],"1.0","!important")."}";
echo $wpstrstr." {background-color: ".wpstr_colorcode($wpstradmin['button-primary-bg'],"1.0","!important")."}";
...
$wpstrstr = " #wpadminbar";
echo wpstr_css_background($wpstrstr, "topbar-menu-bg", "1.0") . "\n";
...
echo wpstr_css_bgcolor($wpstrstr, "topbar-submenu-bg", "1.0") . "\n";


$wpstrstr = " #wpadminbar .ab-top-menu>li.hover>.ab-item, #wpadminbar .ab-top-menu>li:hover>.ab-item, #wpadminbar .ab-top-menu>li>.ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu>li>.ab-item:focus, "
...
echo wpstr_css_color($wpstrstr, "topbar-submenu-color", "1.0") . "\n";


$wpstrstr = " #wpadminbar .quicklinks .menupop.hover ul li a:hover";
echo wpstr_css_border_color($wpstrstr, "primary-color", "", "left") . "\n";
 
$wpstrstr = " #wpadminbar a.ab-item, #wpadminbar>#wp-toolbar span.ab-label, #wpadminbar>#wp-toolbar span.noticon,"
...
echo wpstr_css_color($wpstrstr, "topbar-menu-color", "1.0") . "\n";

$wpstrstr = " body #wpadminbar #wp-admin-bar-user-info:hover a,"
			."body #wpadminbar .quicklinks .menupop.hover ul li a:hover"
			."";
echo wpstr_css_bgcolor($wpstrstr, "topbar-submenu-hover-bg", "1.0") . "\n";
echo wpstr_css_color($wpstrstr, "topbar-submenu-hover-color", "1.0") . "\n";
...
echo " \n/* -- Floating menu -- */\n";
$wpstrstr = "body .fmenu__button--main, body .fmenu__button--child";
echo wpstr_css_background($wpstrstr, "floatingmenu-bg", "1.0") . "\n";

$wpstrstr = "body .fmenu__list .fmenu__child-icon, body .fmenu__list .fmenu__child-icon:before,body .fmenu__button--main, body .fmenu__button--child,body #wpstr-floatingmenu .fmenu__main-icon--resting, body #wpstr-floatingmenu .fmenu__main-icon--resting.dashicons-before:before, body #wpstr-floatingmenu .fmenu__main-icon--active, body #wpstr-floatingmenu .fmenu__main-icon--active.dashicons-before:before";
echo wpstr_css_color($wpstrstr, "floatingmenu-color", "1.0") . "\n";
