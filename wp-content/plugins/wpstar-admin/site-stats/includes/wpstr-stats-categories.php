...
?>
    ...
    ?>
        ...
        <div class="chartBox"><?php //print_r($yearWiseArray); 
            ...
            <div id="wpstr_mostcats_byYear" style='height:180px;'></div>
        </div>


        <script type="text/javascript">
            // Initialize after dom ready
            var myChart5 = echarts.init(document.getElementById('wpstr_mostcats_byYear'));
    ...
    ?>
        ...
        <div class="chartBox"><?php //print_r($yearWiseArray); 
            ...
            <div id="wpstr_lesscats_byYear" style='height:180px;'></div>
        </div>


        <script type="text/javascript">
            // Initialize after dom ready
            var myChart6 = echarts.init(document.getElementById('wpstr_lesscats_byYear'));
