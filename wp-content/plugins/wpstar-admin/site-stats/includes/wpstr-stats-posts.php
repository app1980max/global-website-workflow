...
?>
    ...
    <?php
    $getcolor = wpstr_dashboard_widget_color();
    ...
    ?>
        <div class="chartBox"><?php // print_r($monthsArray); 
            ...
            <div id="wpstr_posts_byMonthYear" style='height:180px;'></div>
        </div>


        <script type="text/javascript">
            // Initialize after dom ready
            var myChart8 = echarts.init(document.getElementById('wpstr_posts_byMonthYear'));
                    ...
                    ?> {
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    borderWidth: 2,
                                    borderColor: '<?php echo $monthsArraycolors[$monthyear]; ?>',
                                    areaStyle: {
                                        color: '<?php echo $monthsArraycolors[$monthyear]; ?>',
                                        type: 'default'
                                    }
    ...
    ?>
        ...
        <div class="chartBox"><?php //print_r($yearWiseArray); 
            ...
            <div id="wpstr_posts_byYear" style='height:180px;'></div>
        </div>


        <script type="text/javascript">
            // Initialize after dom ready
            var myChart9 = echarts.init(document.getElementById('wpstr_posts_byYear'));
                ...
                series: [{
                    ...
                    itemStyle: {
                        normal: {
                            ...
                            borderWidth: 2,
                            borderColor: '<?php echo $getcolor[0]; ?>',
                            areaStyle: {
                                color: '<?php echo $getcolor[0]; ?>',
                                type: 'default'
                            }
