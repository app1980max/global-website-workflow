...
?>    
            <div class="chartBox"><?php //print_r($monthsArray); ?>
                ...
                <div id="wpstr_users_byMonthYear" style='height:180px;'></div>
            </div>


<script type="text/javascript">
        // Initialize after dom ready
        var myChart11 = echarts.init(document.getElementById('wpstr_users_byMonthYear')); 
...
if(sizeof($yearWiseArray) > 0){
       ...
       //  echo "". $x_years." ".$y_total; ?>
            ...
            <div class="chartBox"><?php //print_r($yearWiseArray); ?>
                ...
                <div id="wpstr_users_byYear" style='height:180px;'></div>
            </div>


            <script type="text/javascript">
                    // Initialize after dom ready
                   var myChart12 = echarts.init(document.getElementById('wpstr_users_byYear')); 
