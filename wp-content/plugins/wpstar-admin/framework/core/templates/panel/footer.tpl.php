...
<?php 
            if ( false === $this->parent->args['hide_save'] ) {
                submit_button( __( 'Save Changes', 'wpstr_framework' ), 'primary', 'reduk_save', false );
            }

            if ( false === $this->parent->args['hide_reset'] ) {
                submit_button( __( 'Reset Section', 'wpstr_framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'reduk-defaults-section' ) );
                submit_button( __( 'Reset All', 'wpstr_framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'reduk-defaults' ) );
            } 
?>
        </div>

        <div class="reduk-ajax-loading" alt="<?php _e( 'Working...', 'wpstr_framework' ) ?>">&nbsp;</div>
        <div class="clear"></div>
