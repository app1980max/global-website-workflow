...
// Don't duplicate me!
if ( ! class_exists( 'RedukFramework_border' ) ) {
    
    class RedukFramework_border {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="reduk-border-all reduk-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'All', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
            }

            echo '<input type="hidden" class="reduk-border-value" id="' . $this->field['id'] . '-top" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-top]" value="' . ( isset($this->value['top']) && $this->value['top'] != '' ? $this->value['top'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduk-border-value" id="' . $this->field['id'] . '-right" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-right]" value="' . ( isset($this->value['right']) && $this->value['right'] != '' ? $this->value['right'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduk-border-value" id="' . $this->field['id'] . '-bottom" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-bottom]" value="' . ( isset($this->value['bottom']) && $this->value['bottom'] != '' ? $this->value['bottom'] . 'px' : '' ) . '">';
            echo '<input type="hidden" class="reduk-border-value" id="' . $this->field['id'] . '-left" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-left]" value="' . ( isset($this->value['left']) && $this->value['left'] != '' ? $this->value['left'] . 'px' : '' ) . '">';
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                ...
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="reduk-border-top reduk-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Top', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
                }
                ...
                if ( $this->field['right'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="reduk-border-right reduk-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Right', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
                }
                ...
                if ( $this->field['bottom'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="reduk-border-bottom reduk-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
                }
                ...
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="reduk-border-left reduk-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
                }
            }
            ...
            if ( $this->field['style'] != false ) {
                ...
                echo '<select original-title="' . __( 'Border style', 'wpstr_framework' ) . '" id="' . $this->field['id'] . '[border-style]" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-style]" class="tips reduk-border-style ' . $this->field['class'] . '" rows="6" data-id="' . $this->field['id'] . '">';
            ...
            if ( $this->field['color'] != false ) {
                ...
                echo '<input name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-color]" id="' . $this->field['id'] . '-border" class="reduk-border-color reduk-color reduk-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['color'] . '"  data-default-color="' . $default . '" data-id="' . $this->field['id'] . '" />';
            } else {
        ...
        function enqueue() {
            ...
            if (!wp_script_is ( 'reduk-field-border-js' )) {
                wp_enqueue_script(
                    'reduk-field-border-js',
                    RedukFramework::$_url . 'inc/fields/border/field_border' . $min . '.js',
                    array( 'jquery', 'select2-js', 'wp-color-picker', 'reduk-js' ),
                    time(),
                    true
                );
            }
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                if (!wp_style_is ( 'reduk-field-border-css' )) {
                    wp_enqueue_style(
                        'reduk-field-border-css',
                        RedukFramework::$_url . 'inc/fields/border/field_border.css',
                        array(),
                        time(),
                        'all'
                    );
