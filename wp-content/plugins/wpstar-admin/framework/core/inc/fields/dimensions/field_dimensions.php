<?php
    ...
    if ( ! class_exists( 'RedukFramework_dimensions' ) ) {
        class RedukFramework_dimensions {
            ...
            function render() {
                ...
                echo '<fieldset id="' . $this->field['id'] . '" class="reduk-dimensions-container" data-id="' . $this->field['id'] . '">';
                ...
                if ( $this->field['width'] === true ) {
                    ...
                    echo '<input type="text" class="reduk-dimensions-input reduk-dimensions-width mini ' . $this->field['class'] . '" placeholder="' . __( 'Width', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-width" value="' . filter_var( $this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( $this->field['height'] === true ) {
                    ...
                    echo '<input type="text" class="reduk-dimensions-input reduk-dimensions-height mini ' . $this->field['class'] . '" placeholder="' . __( 'Height', 'wpstr_framework' ) . '" rel="' . $this->field['id'] . '-height" value="' . filter_var( $this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
                    echo '<div class="select_wrapper dimensions-units" original-title="' . __( 'Units', 'wpstr_framework' ) . '">';
                    echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __( 'Units', 'wpstr_framework' ) . '" class="reduk-dimensions reduk-dimensions-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'wpstr_framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'reduk-field-dimensions-js',
                    RedukFramework::$_url . 'inc/fields/dimensions/field_dimensions' . Reduk_Functions::isMin() . '.js',
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'reduk-field-dimensions-css',
                        RedukFramework::$_url . 'inc/fields/dimensions/field_dimensions.css',
                        array(),
                        time(),
                        'all'
                    );
