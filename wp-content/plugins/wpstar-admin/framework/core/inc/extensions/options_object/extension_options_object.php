...
// Don't duplicate me!
    if ( ! class_exists( 'RedukFramework_Extension_options_object' ) ) {


        /**
         * Main RedukFramework options_object extension class
         *
         * @since       3.1.6
         */
        class RedukFramework_Extension_options_object {
            ...
            public function __construct( $parent ) {
                ...
                $this->is_field = Reduk_Helpers::isFieldInUse($parent, 'options_object');
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id' => 'options-object',
                    'title' => __( 'Options Object', 'wpstr_framework' ),
                    'heading' => '',
                    'icon' => 'el el-info-circle',
                    'customizer' => false,
                    'fields' => array(
                        array(
                            'id' => 'reduk_options_object',
                            'type'=> 'options_object',
                            'title' => '',
                        )
                    ),
