    ...
    if ( ! class_exists( 'RedukFramework_import_export' ) ) {
        ...
        class RedukFramework_import_export extends RedukFramework {
            ...
            public function render() {
                ...
                ?>
                    <h4><?php esc_html_e( 'Import Options', 'wpstr_framework' ); ?></h4>

                    <p>
                        <a href="javascript:void(0);" id="reduk-import-code-button" class="button-secondary">
                            <?php esc_html_e( 'Import from File', 'wpstr_framework' ); ?>
                        </a> 
                        <a href="javascript:void(0);" id="reduk-import-link-button" class="button-secondary">
                            <?php esc_html_e( 'Import from URL', 'wpstr_framework' ) ?>
                        </a>
                    </p>

                    <div id="reduk-import-code-wrapper">
                        <p class="description" id="import-code-description">
                            <?php echo esc_html( apply_filters( 'reduk-import-file-description', __( 'Input your backup file below and hit Import to restore your sites options from a backup.', 'wpstr_framework' ) ) ); ?>
                        </p>
                    ...
                    <div id="reduk-import-link-wrapper">
                        <p class="description" id="import-link-description"><?php echo esc_html( apply_filters( 'reduk-import-link-description', __( 'Input the URL to another sites options set and hit Import to load the options from that site.', 'wpstr_framework' ) ) ); ?></p>
                        <?php // $this->parent->args['opt_name'] is sanitized in the RedukFramework class, no need to re-sanitize it. ?>
                    ...
                    <p id="reduk-import-action"><input type="submit" id="reduk-import" name="import" class="button-primary" value="<?php esc_html_e( 'Import', 'wpstr_framework' ) ?>">&nbsp;&nbsp;<span><?php echo esc_html( apply_filters( 'reduk-import-warning', __( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'wpstr_framework' ) ) ) ?></span></p>

                    <div class="hr"/>
                    <div class="inner"><span>&nbsp;</span></div></div>
                    <h4><?php esc_html_e( 'Export Options', 'wpstr_framework' ) ?></h4>

                    <div class="reduk-section-desc">
                        <p class="description">
                            <?php echo esc_html( apply_filters( 'reduk-backup-description', __( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'wpstr_framework' ) ) ) ?>
                        </p>
                    </div>
                <?php
                ...
                ?>
                    <p>
                        <a href="javascript:void(0);" id="reduk-export-code-copy" class="button-secondary"><?php esc_html_e( 'Copy Data', 'wpstr_framework' ) ?></a>
                        <a href="<?php echo $link; ?>" id="reduk-export-code-dl" class="button-primary"><?php esc_html_e( 'Download Data File', 'wpstr_framework' ) ?></a>
                        <a href="javascript:void(0);" id="reduk-export-link" class="button-secondary"><?php esc_html_e( 'Copy Export URL', 'wpstr_framework' ) ?></a>
                    </p>
