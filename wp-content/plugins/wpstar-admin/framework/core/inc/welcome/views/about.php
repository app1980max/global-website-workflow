<div class="wrap about-wrap">
    <h1><?php printf( __( 'Welcome to Reduk Framework %s', 'wpstr_framework' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Reduk Framework %s is a huge step forward in Reduk Development. Look at all that\'s new.', 'wpstr_framework' ), $this->display_version ); ?></div>
    <div
        class="reduk-badge"><i
            class="el el-reduk"></i><span><?php printf( __( 'Version %s', 'wpstr_framework' ), RedukFramework::$_version ); ?></span>
    </div>
    ...
    <div id="reduk-message" class="updated">
        <h4><?php _e( 'What is Reduk Framework?', 'wpstr_framework' ); ?></h4>

        <p><?php _e( 'Reduk Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'wpstr_framework' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>redukframework.com"
               target="_blank"><?php _e( 'Learn More', 'wpstr_framework' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php _e( 'New in this Release', 'wpstr_framework' ); ?></h2>
