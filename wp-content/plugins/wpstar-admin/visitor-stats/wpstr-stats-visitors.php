...
$entries = $wpdb->get_results( "SELECT * FROM {$wpdb->prefix}wpstrwid ORDER BY id DESC LIMIT $offset, $limit" );
...
$total = $wpdb->get_var( "SELECT COUNT(`id`) FROM {$wpdb->prefix}wpstrwid" );
$num_of_pages = ceil( $total / $limit );
$page_links = paginate_links( array(
    'base' => add_query_arg( 'pagenum', '%#%' ),
    'format' => '',
    'prev_text' => __( '&laquo;', 'wpstr_framework' ),
    'next_text' => __( '&raquo;', 'wpstr_framework' ),
    'total' => $num_of_pages,
    'current' => $pagenum
) );
...
.wpstr-wid-box {
  ...
  border-bottom: 2px dotted #117042;
  border-top: 2px dotted #117042;
  padding-bottom: 30px;
}

.wpstr-wid-box .box-title {
  font-size: 14px;
  font-weight: bold;
