...
if ( ! class_exists( 'STM_Customizer_Text_Transform_Control' ) ) {
	...
	class STM_Customizer_Text_Transform_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$transform = array(
				'capitalize'       => esc_html__( 'Capitalize', 'crypterio' ),
				'lowercase' => esc_html__( 'Lowercase', 'crypterio' ),
				'uppercase'       => esc_html__( 'Uppercase', 'crypterio' ),
				'none' => esc_html__( 'Normal', 'crypterio' )
			);
