...
$socials = array(
	'bitcoin'       => esc_html__( 'Bitcoin Talk', 'crypterio' ),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_ico_listing_enable'    => array(
				'label'   => esc_html__( 'Enable ico listing post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_services_enable'    => array(
				'label'   => esc_html__( 'Enable services post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_careers_enable'    => array(
				'label'   => esc_html__( 'Enable vacancies post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_staff_enable'    => array(
				'label'   => esc_html__( 'Enable staff post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_works_enable'    => array(
				'label'   => esc_html__( 'Enable works post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_testimonials_enable'    => array(
				'label'   => esc_html__( 'Enable testimonials post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_events_enable'    => array(
				'label'   => esc_html__( 'Enable events post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	...
	array(
		...
		'fields' => array(
			...
			'post_type_portfolio_enable'    => array(
				'label'   => esc_html__( 'Enable portfolio post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	'post_type_nft',
	array(
		'title'  => esc_html__( 'NFT', 'crypterio' ),
		'panel'  => 'post_types',
		'fields' => array(
			'post_type_nft_title'     => array(
				'label'   => esc_html__( 'Title', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'NFT', 'crypterio' ),
			),
			'post_type_nft_plural'    => array(
				'label'   => esc_html__( 'Plural Title', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'NFT', 'crypterio' ),
			),
			'post_type_nft_all_items' => array(
				'label'   => esc_html__( 'All Items', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'All NFT', 'crypterio' ),
			),
			'post_type_nft_rewrite'   => array(
				'label'   => esc_html__( 'Rewrite (URL text)', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => 'nft',
			),
			'post_type_nft_icon'      => array(
				'label'   => esc_html__( 'Icon', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => 'dashicons-format-image',
			),
			'post_type_nft_enable'    => array(
				'label'   => esc_html__( 'Enable NFT post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
...
STM_Customizer::setSection(
	'post_type_nft_packs',
	array(
		'title'  => esc_html__( 'NFT Packs', 'crypterio' ),
		'panel'  => 'post_types',
		'fields' => array(
			'post_type_nft_packs_title'     => array(
				'label'   => esc_html__( 'Title', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'NFT Pack', 'crypterio' ),
			),
			'post_type_nft_packs_plural'    => array(
				'label'   => esc_html__( 'Plural Title', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'NFT Packs', 'crypterio' ),
			),
			'post_type_nft_packs_all_items' => array(
				'label'   => esc_html__( 'All Items', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => esc_html__( 'All NFT Packs', 'crypterio' ),
			),
			'post_type_nft_packs_rewrite'   => array(
				'label'   => esc_html__( 'Rewrite (URL text)', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => 'nft_packs',
			),
			'post_type_nft_packs_icon'      => array(
				'label'   => esc_html__( 'Icon', 'crypterio' ),
				'type'    => 'stm-text',
				'default' => 'dashicons-format-gallery',
			),
			'post_type_nft_packs_enable'    => array(
				'label'   => esc_html__( 'Enable NFT Packs post type', 'crypterio' ),
				'type'    => 'stm-checkbox',
				'default' => true,
			),
		),
