...
if ( ! class_exists( 'STM_Customizer' ) ) {
    class STM_Customizer {
        ...
        public static function output_css() {
            ...
            if ( self::$output_css ) {
                $stm_css = str_replace('font-family:Exo 2', 'font-family:"Exo 2"', self::$output_css);
                echo '<style type="text/css" title="dynamic-css" class="options-output">' . $stm_css . '</style>' . "\n";
            }
