...
$stm_animation = (!empty($atts['css_animation'])) ? $atts['css_animation'] : '';
...
if(!empty($stm_animation)) {
	$css_class .= ' ' . blockchain_vpb_animate_style($stm_animation);
}
