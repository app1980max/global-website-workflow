...
wp_enqueue_style( 'crypterio-animate.min.css' );
...
if($testimonials->have_posts()): $i = 0; ?>
	<div class="stm_l17_testimonials row-in-<?php echo crypterio_sanitize_text_field($count); ?>">
		<div class="slick_prev"><i class="fas fa-chevron-left"></i></div>
		<div class="slick_next"><i class="fas fa-chevron-right"></i></div>
	...
	<script type="text/javascript">
		jQuery('document').ready(function(){
			...
			$('.stm_l17_testimonials .slick_next').on('click', function(){
				...
				$('.pager_unit_' + nextSlide).trigger('click');
			})
