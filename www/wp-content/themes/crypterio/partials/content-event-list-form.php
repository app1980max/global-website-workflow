...
<div id="event-form-box" class="event-members-box-wrap">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 required-info">
            <?php esc_html_e("* All fields are required", 'crypterio'); ?>
        </div>
    ...
    <form id="event-members-form" action="<?php echo esc_url( home_url('/') ); ?>" method="post">
        <div class="event-members-box">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <?php if( $event_terms_conditions = get_theme_mod( 'event_terms_conditions', wp_kses( __( "I agree with the all additional <a href='http://stylemixthemes.com/' target='_blank'>Terms and Conditions</a>", 'crypterio' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) ) ): ?>
                        <div class="event_terms_conditions">
                            ...
                            <label for="event_terms_conditions"><?php printf(esc_html__( '%s', 'crypterio'), $event_terms_conditions); ?></label>
                        </div>
                    <?php endif; ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                    <div class="input-group">
                        ...
                        <button type="submit" class="button size-lg icon_left disabled" disabled><i class="fas fa-chevron-right"></i> <?php esc_html_e( "join", 'crypterio' ); ?></button>
                    </div>
                </div>
            </div>
            ...
            <div class="form__notice_information form__notice_success alert-modal alert alert-danger text-left">
                <?php esc_html_e( "You already has been joined the event.", 'crypterio' ); ?>
            </div>
        </div>
    </form>
</div>
