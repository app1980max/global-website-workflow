...
?>   
            <div class="chartBox"><?php //print_r($monthsArray); ?>
                ...
                <div id="wpstr_comments_byMonthYear" style='height:180px;'></div>
            </div>

            <script type="text/javascript">
                    // Initialize after dom ready
                    var myChart2 = echarts.init(document.getElementById('wpstr_comments_byMonthYear')); 
                    ...
                    //window.onresize = echarts.init(document.getElementById('wpstr_comments_byMonthYear')).resize;
...
if(sizeof($yearWiseArray) > 0){
      ...
      //   echo "". $x_years." ".$y_total; ?>
            ...
            <div class="chartBox"><?php //print_r($yearWiseArray); ?>
                ...
                <div id="wpstr_comments_byYear" style='height:180px;'></div>
            </div>


            <script type="text/javascript">
                    // Initialize after dom ready
                   var myChart3 = echarts.init(document.getElementById('wpstr_comments_byYear')); 
