<?php
    // <input type="radio" value="1" name="_customize-radio-reduk_demo[opt-radio]" data-customize-setting-link="reduk_demo[opt-color-title]">
    //return;
    /**
    ...
    // Don't duplicate me!
    if ( ! class_exists( 'RedukFramework_extension_customizer' ) ) {

        /**
         * Main RedukFramework customizer extension class
         *
         * @since       1.0.0
         */
        class RedukFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                $this->upload_dir = RedukFramework::$_upload_dir . 'advanced-customizer/';
                ...
                // Override the RedukCore class
                add_filter( "reduk/extension/{$this->parent->args['opt_name']}/customizer", array(
                    $this,
                ...
                if ( isset( $_POST['wp_customize'] ) && $_POST['wp_customize'] == "on" && isset( $_POST['customized'] ) && ! empty( $_POST['customized'] ) && ! isset( $_POST['action'] ) ) {
                    add_action( "reduk/options/{$this->parent->args['opt_name']}/options", array(
                        $this,
                        '_override_values'
                    ), 100 );
                }
            ...
            function enqueue_controls_css() {
                ...
                require_once RedukFramework::$_dir . 'core/enqueue.php';
                $enqueue = new redukCoreEnqueue ( $this->parent );
                $enqueue->get_warnings_and_errors_array();
                $enqueue->init();
                wp_enqueue_style( 'reduk-extension-advanced-customizer', $this->_extension_url . 'extension_customizer.css', '', time() );

                wp_enqueue_script(
                    'reduk-extension-customizer',
                    $this->_extension_url . 'extension_customizer' . Reduk_Functions::isMin() . '.js',
                    array( 'jquery', 'reduk-js' ),
                    RedukFramework_extension_customizer::$version,
                    true
                );
                wp_localize_script( 'reduk-extension-customizer', 'reduk_customizer', array( 'body_class' => sanitize_html_class( 'admin-color-' . get_user_option( 'admin_color' ), 'fresh' ) ) );
            }
            ...
            function customize_preview_init() {
                do_action( 'reduk/customizer/live_preview' );
            }
            ...
            public function _enqueue_new() {
                ...
                /*
                  wp_enqueue_script('reduk-extension-customizer-codemirror-js', $this->_extension_url . 'new/codemirror.min.js');
                  wp_enqueue_script('reduk-extension-customizer-color-js', $this->_extension_url . 'new/colors-control.js');
                  wp_enqueue_script('reduk-extension-customizer-controls-js', $this->_extension_url . 'new/customizer-control.js');
                  wp_enqueue_script('reduk-extension-customizer-fonts-js', $this->_extension_url . 'new/fonts-customizer-admin.js');
                  wp_enqueue_script('reduk-extension-customizer-header-js', $this->_extension_url . 'new/header-control.js');
                  wp_enqueue_script('reduk-extension-customizer-models-js', $this->_extension_url . 'new/header-models.js');
                  wp_enqueue_script('reduk-extension-customizer-slimscroll-js', $this->_extension_url . 'new/jquery.slimscroll.js');
                  wp_enqueue_script('reduk-extension-customizer-droppable-js', $this->_extension_url . 'new/jquery.ui.droppable.min.js');
                  wp_enqueue_script('reduk-extension-customizer-editor-js', $this->_extension_url . 'new/media-editor.min.js');
                  wp_enqueue_script('reduk-extension-customizer-new-js', $this->_extension_url . 'new/new-customizer.js');
                  wp_enqueue_script('reduk-extension-customizer-previewing-js', $this->_extension_url . 'new/previewing.js');
                  wp_enqueue_script('reduk-extension-customizer-theme-js', $this->_extension_url . 'new/theme-customizer.js');
                 */
            }

            public function render( $control ) {
                $fieldID = str_replace( $this->parent->args['opt_name'] . '-', '', $control->reduk_id );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Reduk_Customizer_Section' ) ) {
                    require_once dirname( __FILE__ ) . '/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Reduk_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Reduk_Customizer_Panel' ) ) {
                    require_once dirname( __FILE__ ) . '/inc/customizer_panel.php';
                    if ( method_exists( $wp_customize, 'register_panel_type' ) ) {
                        $wp_customize->register_panel_type( 'Reduk_Customizer_Panel' );
                    }
                }
                if ( ! class_exists( 'Reduk_Customizer_Control' ) ) {
                ...
                do_action( "reduk/extension/customizer/control/includes" );

                //if ($this->parent->args['dev_mode']) {
                //    $section = new Reduk_Customizer_rAds( $wp_customize, 'reduk_rAds', array(
                //        'priority'    => 0,
                //    ) );
                ...
                //    ) );
                //
                //    //$wp_customize->add_control( new Reduk_Customizer_Control_rAds( $wp_customize, 'redukAdsDisplay', array(
                //    //    'section'        => 'reduk_rAds',
                //    //    'settings'       => 'reduk_rAds_field',
                //    //    'type'           => 'reduk-rAds',
                //    //) ) );
                //
                //
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    ...
                    //    'priority'    => 0,
                    //);
                    ////$section = new Reduk_Customizer_Section( $wp_customize, 'reduk_rAds', $args );
                    ////$wp_customize->add_section( $section, $args );
                    //$this->add_section( 'reduk_rAds', array(
                    //    'title'       => '',
                    //    'priority'    => 1,
                    //    'description' => '',
                    ...
                    //$section = new Reduk_Customizer_section_rAds( $wp_customize, 'reduk_rAds', array(
                    //    'priority'    => -999,
                    //) );
                    //$wp_customize->add_section( $section, array(
                    //    'priority'    => -999,
                    ...
                    //    new Reduk_Customizer_Control_rAds(
                    //        $wp_customize,
                    //        'reduk_rAds_empty',
                    //        array(
                    //            'section'    => 'reduk_rAds',
                    //            'settings'   => 'reduk_rAds_empty'
                    //        )
                    //    )
                    //);
                }
                ...
                foreach ( $this->parent->sections as $key => $section ) {
                    ...
                    foreach ( $section['fields'] as $skey => $option ) {
                        ...
                        add_action( 'reduk/advanced_customizer/control/render/' . $this->parent->args['opt_name'] . '-' . $option['id'], array(
                            $this,
                            'render'
                        ) );
                        ...
                        $class_name = 'Reduk_Customizer_Control_' . $option['type'];

                        do_action( 'reduk/extension/customizer/control_init', $option );
                        ...
                        $wp_customize->add_control( new $class_name( $wp_customize, $option['id'], array(
                            ...
                            'section'        => $section['id'],
                            'settings'       => $option['id'],
                            'type'           => 'reduk-' . $option['type'],
                            'field'          => $option,
                            'RedukFramework' => $this->parent,
                        ...
                        add_action( 'reduk/advanced_customizer/render/' . $option['id'], array(
                            $this,
                            'field_render'
                        ), $option['priority'] );
            ...
            public function add_section( $id, $args = array(), $wp_customize ) {
                ...
                if ( is_a( $id, 'WP_Customize_Section' ) ) {
                    ...
                    $section_class = apply_filters( 'reduk/customizer/section/class_name', "Reduk_Customizer_Section" );
            ...
            public function add_panel( $id, $args = array(), $wp_customize ) {
                if ( is_a( $id, 'WP_Customize_Panel' ) ) {
                    ...
                    $panel_class = apply_filters( 'reduk/customizer/panel/class_name', "Reduk_Customizer_Panel" );
            ...
            public function customizer_save_after( $wp_customize ) {
                ...
                if ( $changed ) {
                    ...
                    if ( $compiler ) {
                        ...
                        do_action( "reduk/options/{$this->parent->args['opt_name']}/compiler", $this->parent->options, $this->parent->compilerCSS );
                        do_action( "reduk/options/{$this->args['opt_name']}/compiler/advanced", $this->parent );
                    }
                }
            ...
            public function _enqueue_previewer() {
                wp_enqueue_script(
                    'reduk-extension-previewer-js',
                    $this->_extension_url . 'assets/js/preview.js'
                );

                $localize = array(
                    'save_pending'   => __( 'You have changes that are not saved. Would you like to save them now?', 'wpstr_framework' ),
                    'reset_confirm'  => __( 'Are you sure? Resetting will lose all custom values.', 'wpstr_framework' ),
                    'preset_confirm' => __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'wpstr_framework' ),
            ...
            public function _enqueue() {
                ...
                //wp_enqueue_script('reduk-extension-customizer-js', $this->_extension_url . 'assets/js/customizer.js');
                // Get styles
                //wp_enqueue_style('reduk-extension-customizer-css', $this->_extension_url . 'assets/css/customizer.css');
                ...
                do_action( 'reduk-enqueue-' . $this->args['opt_name'] );
                        ...
                        foreach ( $section['fields'] as $field ) {
                            if ( isset( $field['type'] ) ) {
                                ...
                                if ( ! class_exists( $field_class ) ) {
                                    $class_file = apply_filters( 'reduk-typeclass-load', $this->path . 'inc/fields/' . $field['type'] . '/field_' . $field['type'] . '.php', $field_class );
                                    if ( $class_file ) {
        ...
        function reduk_customizer_custom_validation( $field ) {
            return $field;
        }
    } // if
