...
if ( ! class_exists( 'RedukFramework_select_image' ) ) {
    class RedukFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'wpstr_framework' );
                ...
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="reduk-select-item reduk-select-images ' . $this->field['class'] . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                if ( '' == $this->value ) {
                    echo '<img src="#" class="reduk-preview-image" style="visibility:hidden;" id="image_' . $this->field['id'] . '">';
                } else {
                    echo '<img src=' . $this->field['options'][ $arrNum - 1 ]['img'] . ' class="reduk-preview-image" id="image_' . $this->field['id'] . '">';
                }
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'wpstr_framework' ) . '</strong>';
            }
        } //function
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                ...
                RedukFramework::$_url . 'inc/fields/select_image/field_select_image' . Reduk_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'reduk-field-select-image-css',
                    RedukFramework::$_url . 'inc/fields/select_image/field_select_image.css',
                    array(),
                    time(),
                    'all'
                );
