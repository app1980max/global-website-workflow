...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'RedukFramework_password' ) ) {
        class RedukFramework_password {
            ...
            private function _render_combined_field() {
                ...
                $defaults = array(
                    ...
                    'password'    => '',
                    'placeholder' => array(
                        'password' => __( 'Password', 'wpstr_framework' ),
                        'username' => __( 'Username', 'wpstr_framework' )
                    )
                );
