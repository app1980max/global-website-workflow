<?php
    ...
    if ( ! class_exists( 'redukCoreEnqueue' ) ) {
        class redukCoreEnqueue {
            public $parent = null;
            ...
            public function init() {
                $this->min = Reduk_Functions::isMin();

                $this->timestamp = RedukFramework::$_version;
                ...
                add_filter("reduk/{$this->parent->args['opt_name']}/localize", array('Reduk_Helpers', 'localize'));

                $this->set_localized_data();
                
                /**
                 * action 'reduk-enqueue-{opt_name}'
                 *
                 * @deprecated
                 *
                 * @param  object $this RedukFramework
                 */
                do_action( "reduk-enqueue-{$this->parent->args['opt_name']}", $this->parent ); // REMOVE

                /**
                 * action 'reduk/page/{opt_name}/enqueue'
                 */
                do_action( "reduk/page/{$this->parent->args['opt_name']}/enqueue" );
            }
            ...
            private function register_styles() {
                ...
                wp_enqueue_style(
                    'reduk-admin-css',
                    RedukFramework::$_url . 'assets/css/reduk-admin.css',
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                if ( ! $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'reduk-fields-css',
                        RedukFramework::$_url . 'assets/css/reduk-fields.css',
                        array(),
                        $this->timestamp,
                        'all'
                    );
                ...
                // Spectrum CSS
                //*****************************************************************
                $css_file = 'reduk-spectrum.min.css';
                if ($this->parent->args['dev_mode']) {
                    $css_file = 'reduk-spectrum.css';
                }                
                
                wp_register_style(
                    'reduk-spectrum-css',
                    RedukFramework::$_url . 'assets/css/vendor/spectrum/' . $css_file,
                    array(),
                    '1.3.3',
                    'all'
                );
                ...
                wp_enqueue_style(
                    'reduk-elusive-icon',
                    RedukFramework::$_url . 'assets/css/vendor/elusive-icons/elusive-icons.css',
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                wp_enqueue_style(
                    'qtip-css',
                    RedukFramework::$_url . 'assets/css/vendor/qtip/' . $css_file,
                    array(),
                    '2.2.0',
                    'all'
                );
                ...
                wp_enqueue_style(
                    'jquery-ui-css',
                    apply_filters( "reduk/page/{$this->parent->args['opt_name']}/enqueue/jquery-ui-css", RedukFramework::$_url . 'assets/css/vendor/jquery-ui-bootstrap/jquery-ui-1.10.0.custom.css' ),
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    ...
                    //*****************************************************************
                    wp_register_style(
                        'reduk-color-picker-css',
                        RedukFramework::$_url . 'assets/css/color-picker/color-picker.css',
                    ...
                    //*****************************************************************
                    wp_enqueue_style(
                        'reduk-field-media-css',
                        RedukFramework::$_url . 'assets/css/media/media.css',
                        array(),
                        time(),
                        'all'
                    );
                ...
                if ( is_rtl() ) {
                    wp_enqueue_style(
                        'reduk-rtl-css',
                        RedukFramework::$_url . 'assets/css/rtl.css',
                        array( 'reduk-admin-css' ),
                        $this->timestamp,
                        'all'
                    );
                }
            ...
            private function register_scripts() {
                ...
                //*****************************************************************
                wp_register_script(
                    'reduk-select2-sortable-js',
                    RedukFramework::$_url . 'assets/js/vendor/reduk.select2.sortable' . $this->min . '.js',
                    array( 'jquery' ),
                    $this->timestamp,
                    true
                );
                ...
                Reduk_CDN::register_script(
                    'select2-js',
                    '//cdn.jsdelivr.net/select2/3.5.2/select2' . $this->min . '.js',
                    array( 'jquery', 'reduk-select2-sortable-js' ),
                    '3.5.2',
                    true
                );
                ...
                wp_enqueue_script(
                    'qtip-js',
                    RedukFramework::$_url . 'assets/js/vendor/qtip/' . $js_file,
                    array( 'jquery' ),
                    '2.2.0',
                    true
                );
                ...
                // Spectrum JS
                //*****************************************************************
                $js_file = 'reduk-spectrum.min.js';
                if ($this->parent->args['dev_mode']) {
                    $js_file = 'reduk-spectrum.js';
                }
                
                wp_register_script(
                    'reduk-spectrum-js',
                    RedukFramework::$_url . 'assets/js/vendor/spectrum/' . $js_file,
                    array( 'jquery' ),
                    '1.3.3',
                    true
                );                
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    wp_register_script(
                        'reduk-vendor',
                        RedukFramework::$_url . 'assets/js/vendor.min.js',
                        array( 'jquery' ),
                        $this->timestamp,
                        true
                    );

                    array_push( $depArray, 'reduk-vendor' );
                }
                ...
                wp_register_script(
                    'reduk-js',
                    RedukFramework::$_url . 'assets/js/reduk' . $this->min . '.js',
                    $depArray,
                    $this->timestamp,
                    true
                );
            ...
            public function _enqueue_field($field) {
                ...
                if ( isset( $field['type'] ) && $field['type'] != 'callback' ) {
                     ...
                     */
                    $class_file = apply_filters( "reduk/{$this->parent->args['opt_name']}/field/class/{$field['type']}", RedukFramework::$_dir . "inc/fields/{$field['type']}/field_{$field['type']}.php", $field );
                    if ( $class_file ) {
                        ...
                        if ( ( method_exists( $field_class, 'enqueue' ) ) || method_exists( $field_class, 'localize' ) ) {
                            ...
                            if ( ! wp_script_is( 'reduk-field-' . $field['type'] . '-js', 'enqueued' ) && class_exists( $field_class ) && method_exists( $field_class, 'enqueue' ) ) {
                                $theField->enqueue();
                            }
            ...
            private function set_localized_data() {
                ...
                /**
                 * Save pending string
                 * filter 'reduk/{opt_name}/localize/save_pending
                 *
                 * @param       string        save_pending string
                 */
                $save_pending = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/save_pending", __( 'You have changes that are not saved. Would you like to save them now?', 'wpstr_framework' ) );

                /**
                 * Reset all string
                 * filter 'reduk/{opt_name}/localize/reset
                 *
                 * @param       string        reset all string
                 */
                $reset_all = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/reset", __( 'Are you sure? Resetting will lose all custom values.', 'wpstr_framework' ) );

                /**
                 * Reset section string
                 * filter 'reduk/{opt_name}/localize/reset_section
                 *
                 * @param       string        reset section string
                 */
                $reset_section = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/reset_section", __( 'Are you sure? Resetting will lose all custom values in this section.', 'wpstr_framework' ) );

                /**
                 * Preset confirm string
                 * filter 'reduk/{opt_name}/localize/preset
                 *
                 * @param       string        preset confirm string
                 */
                $preset_confirm = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize/preset", __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'wpstr_framework' ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => __( 'Please Wait', 'wpstr_framework' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => __( 'There was an error saving. Here is the result of your action:', 'wpstr_framework' ),
                    'alert'   => __( 'There was a problem with your action. Please try again or reload the page.', 'wpstr_framework' ),
                );

                $this->parent->localize_data = apply_filters( "reduk/{$this->parent->args['opt_name']}/localize", $this->parent->localize_data );
                ...
                wp_enqueue_script( 'reduk-js' ); // Enque the JS now
